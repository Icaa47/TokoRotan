...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('image/icon_tokorotan.jpg') }}">
    <title>tokorotan</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('image/logo_rotan.jpg') }}" alt="homepage" class="light-logo" width="60" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('image/logo_text_rotan.jpg') }}" alt="homepage" class="light-logo" width="110" />
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                Decca rotan by <a
                    href="https://Decca.com">Iccadea</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <script src="{{ asset('backend/libs/popper.js/umd/popper.min.js') }}"></script>
    <script src="{{ asset('backend/libs/bootstrap/js/bootstrap.min.js') }}"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{ asset('backend/libs/perfect-scrollbar/perfect-scrollbar.jquery.min.js') }}"></script>
